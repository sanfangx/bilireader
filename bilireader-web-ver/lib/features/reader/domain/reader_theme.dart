...
/// 閱讀主題。忠實移植自 api-ver。**主題只負責顏色/背景，不覆寫字級/行距**
...
class ReaderTheme {
  ...
  /// 供 `reader_custom_themes` 本機 JSON 持久化（顏色存 int）。
...
class ReaderThemeState {
  ...
  /// 內建 + 自訂（供選單/依 id 查找）。
  List<ReaderTheme> get all => <ReaderTheme>[...kBuiltInReaderThemes, ...custom];
