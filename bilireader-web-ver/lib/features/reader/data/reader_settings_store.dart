...
/// 閱讀器設定的本機持久化（SharedPreferences）。忠實移植自 api-ver（鍵名對齊，便於日後遷移）。
...
class ReaderSettingsStore {
  ...
  // 字體·排版 + 行為
  static const String kFontFamily = 'reader_font_family';
  ...
  /// 保存目前套用主題：id 為 source of truth；同時鏡射色值到顏色鍵（write-only，供對齊）。
