...
@ProviderFor(privateMessageDao)
final privateMessageDaoProvider = PrivateMessageDaoProvider._();

final class PrivateMessageDaoProvider
    extends
        $FunctionalProvider<
          PrivateMessageDao,
          PrivateMessageDao,
          PrivateMessageDao
        >
    with $Provider<PrivateMessageDao> {
  PrivateMessageDaoProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'privateMessageDaoProvider',
        isAutoDispose: false,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$privateMessageDaoHash();

  @$internal
  @override
  $ProviderElement<PrivateMessageDao> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  PrivateMessageDao create(Ref ref) {
    return privateMessageDao(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(PrivateMessageDao value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<PrivateMessageDao>(value),
    );
  }
}

String _$privateMessageDaoHash() => r'0dd8fbae2da3dee8199fe450da32d77d3c50a7b0';
